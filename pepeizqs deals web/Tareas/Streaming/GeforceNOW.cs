...
namespace Tareas.Streaming
{
    ...
    {
        private string id = "geforcenow";

        private readonly ILogger<GeforceNOW> _logger;
        private readonly IServiceScopeFactory _factoria;
        private readonly IDecompiladores _decompilador;

        public GeforceNOW(ILogger<GeforceNOW> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
        {
            _logger = logger;
            _factoria = factory;
