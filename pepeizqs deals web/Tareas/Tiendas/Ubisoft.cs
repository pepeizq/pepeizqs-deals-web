...
{
    public class Ubisoft : BackgroundService
    {
        private string id = APIs.Ubisoft.Tienda.Generar().Id;

        private readonly ILogger<Ubisoft> _logger;
        private readonly IServiceScopeFactory _factoria;
        private readonly IDecompiladores _decompilador;

        public Ubisoft(ILogger<Ubisoft> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
        {
            _logger = logger;
            _factoria = factory;
