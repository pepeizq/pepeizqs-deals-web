...
{
	public class GamesplanetDe : BackgroundService
	{
		private string id = APIs.Gamesplanet.Tienda.GenerarDe().Id;

		private readonly ILogger<GamesplanetDe> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public GamesplanetDe(ILogger<GamesplanetDe> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
