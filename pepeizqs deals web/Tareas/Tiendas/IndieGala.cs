...
{
	public class IndieGala : BackgroundService
	{
		private string id = APIs.IndieGala.Tienda.Generar().Id;

		private readonly ILogger<IndieGala> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public IndieGala(ILogger<IndieGala> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
