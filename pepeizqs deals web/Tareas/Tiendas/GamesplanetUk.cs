...
{
	public class GamesplanetUk : BackgroundService
	{
		private string id = APIs.Gamesplanet.Tienda.GenerarUk().Id;

		private readonly ILogger<GamesplanetUk> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public GamesplanetUk(ILogger<GamesplanetUk> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
