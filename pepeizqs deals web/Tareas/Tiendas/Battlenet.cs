...
{
	public class Battlenet : BackgroundService
	{
		private string id = APIs.Battlenet.Tienda.Generar().Id;

		private readonly ILogger<Battlenet> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public Battlenet(ILogger<Battlenet> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
