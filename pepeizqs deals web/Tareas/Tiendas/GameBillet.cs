...
{
	public class GameBillet : BackgroundService
	{
		private string id = APIs.GameBillet.Tienda.Generar().Id;

		private readonly ILogger<GameBillet> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public GameBillet(ILogger<GameBillet> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
