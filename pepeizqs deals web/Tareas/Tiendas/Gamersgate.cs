...
{
	public class Gamersgate : BackgroundService
	{
		private string id = APIs.GamersGate.Tienda.Generar().Id;

		private readonly ILogger<Gamersgate> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public Gamersgate(ILogger<Gamersgate> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
