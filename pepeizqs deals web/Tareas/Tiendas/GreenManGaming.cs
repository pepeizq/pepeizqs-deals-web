...
{
	public class GreenManGaming : BackgroundService
	{
		private string id = APIs.GreenManGaming.Tienda.Generar().Id;

		private readonly ILogger<GreenManGaming> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public GreenManGaming(ILogger<GreenManGaming> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
