...
{
	public class _2Game : BackgroundService
	{
		private string id = APIs._2Game.Tienda.Generar().Id;

		private readonly ILogger<_2Game> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public _2Game(ILogger<_2Game> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
