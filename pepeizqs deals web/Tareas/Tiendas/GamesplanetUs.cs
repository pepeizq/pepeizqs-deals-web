...
{
	public class GamesplanetUs : BackgroundService
	{
		private string id = APIs.Gamesplanet.Tienda.GenerarUs().Id;

		private readonly ILogger<GamesplanetUs> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public GamesplanetUs(ILogger<GamesplanetUs> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
