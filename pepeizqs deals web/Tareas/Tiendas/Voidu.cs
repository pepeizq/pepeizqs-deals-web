...
{
	public class Voidu : BackgroundService
	{
		private string id = APIs.Voidu.Tienda.Generar().Id;

		private readonly ILogger<Voidu> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public Voidu(ILogger<Voidu> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
