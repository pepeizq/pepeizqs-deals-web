...
{
	public class DLGamer : BackgroundService
	{
		private string id = APIs.DLGamer.Tienda.Generar().Id;

		private readonly ILogger<DLGamer> _logger;
		private readonly IServiceScopeFactory _factoria;
		private readonly IDecompiladores _decompilador;

		public DLGamer(ILogger<DLGamer> logger, IServiceScopeFactory factory, IDecompiladores decompilador)
		{
			_logger = logger;
			_factoria = factory;
