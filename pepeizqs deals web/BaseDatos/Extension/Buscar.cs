...
namespace BaseDatos.Extension
{
	...
	{
		public static Extension Steam(string id, SqlConnection conexion = null)
		{
			if (conexion == null)
			{
			...
			string buscar = "SELECT id, nombre, precioMinimosHistoricos, precioActualesTiendas, bundles, gratis, suscripciones FROM juegos WHERE idSteam=@idSteam";
		...
		public static Extension Gog(string slug, SqlConnection conexion = null)
		{
			if (conexion == null)
			{
				conexion = Herramientas.BaseDatos.Conectar();
			...
			string buscar = "SELECT id, nombre, precioMinimosHistoricos, precioActualesTiendas, bundles, gratis, suscripciones FROM juegos WHERE slugGOG=@slugGOG";

			using (SqlCommand comando = new SqlCommand(buscar, conexion))
			{
				comando.Parameters.AddWithValue("@slugGOG", slug);
		...
		public static Extension EpicGames(string slug, SqlConnection conexion = null)
		{
			if (conexion == null)
			{
				conexion = Herramientas.BaseDatos.Conectar();
			...
			string buscar = "SELECT id, nombre, precioMinimosHistoricos, precioActualesTiendas, bundles, gratis, suscripciones FROM juegos WHERE slugEpic=@slugEpic";

			using (SqlCommand comando = new SqlCommand(buscar, conexion))
			{
				comando.Parameters.AddWithValue("@slugEpic", slug);
